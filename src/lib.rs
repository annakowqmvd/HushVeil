...
#[derive(Debug)]
pub struct HushVeilProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HushVeilProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HushVeil processing");
    
    let mut processor = HushVeilProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HushVeilProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HushVeilProcessor::new(false);
